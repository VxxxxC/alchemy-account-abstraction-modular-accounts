...
contract SubscriptionPlugin is BasePlugin {
    ...
    //* NOTE: This is call directly by collector [plugin -> smart account -> collector with 10 native currency]
        ...
        returns (PluginManifest memory)
    {
        ...
        manifest.dependencyInterfaceIds[0] = type(IMultiOwnerPlugin)
            .interfaceId;
